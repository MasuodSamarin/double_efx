...
C_SRCS += \
../Core/app/event/btn.c \
../Core/app/event/enc.c \
../Core/app/event/event.c \
../Core/app/event/vol.c 

OBJS += \
./Core/app/event/btn.o \
./Core/app/event/enc.o \
./Core/app/event/event.o \
./Core/app/event/vol.o 

C_DEPS += \
./Core/app/event/btn.d \
./Core/app/event/enc.d \
./Core/app/event/event.d \
./Core/app/event/vol.d 


# Each subdirectory must supply rules for building sources it contributes
Core/app/event/%.o: ../Core/app/event/%.c
	@echo 'Building file: $<'
